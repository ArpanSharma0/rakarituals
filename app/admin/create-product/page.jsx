...
import { createProduct, uploadImage, fetchCategories, createCategory as createCategoryAPI, deleteCategory as deleteCategoryAPI } from "@/utils/api";
...
export default function CreateProductPage() {
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      ...
      await createProduct({ ...formData, images: imageUrls, image: imageUrls[0] });
