                      ...
                      <tr key={order._id} className="border-b border-[#f2eee9] hover:bg-[#fcfbf9]/50 transition-colors text-xs text-[#2b2622]">
                        ...
                        <td className="py-6 px-6 space-y-1">
                          <div className="flex items-center gap-2">
                            <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border ${order.deliveryStatus === "Delivered"
                          ...
                          {updatingId === order._id ? (
                            ...
                            <div className="relative w-36 status-dropdown-container">
                              ...
                              {openDropdownId === order._id && (
                                <div className={`absolute left-0 z-50 bg-[#e8e1d9] border border-[#dcd4cb] rounded-2xl p-1.5 shadow-[0_15px_40px_rgba(43,38,34,0.15)] w-full backdrop-blur-md flex flex-col gap-1 transition-all ${isLastRow ? "bottom-full mb-2 origin-bottom" : "top-full mt-2 origin-top"
                                  }`}>
                                  {[
                                    ...
                                    <button
                                      ...
                                      className={`w-full text-left px-3 py-2 text-[9px] font-black uppercase tracking-wider rounded-xl transition-all duration-300 cursor-pointer ${(order.deliveryStatus || "Placed") === opt.val
